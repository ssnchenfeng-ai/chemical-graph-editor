...
const TANK_PORTS = {
  ...
  items: [
    ...
    { group: 'bottom', args: { x: '30%', y: '100%' }, data: { desc: 'N6' } as PortData },
    { group: 'bottom', args: { x: '70%', y: '100%' }, data: { desc: 'N7' } as PortData },
    { group: 'left', args: { x: '0%', y: '50%' }, data: { desc: 'N8' } as PortData },
    { group: 'right', args: { x: '100%', y: '50%' }, data: { desc: 'N9' } as PortData },
  ],
};
